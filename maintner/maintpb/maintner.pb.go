...
type GithubIssueMutation struct {
	...
	// issue_field_event records individual changes to the org-level issue fields
	// above, so past values can be reconstructed rather than only the current
	// snapshot. Events accumulate: a mutation carries only ones not yet known,
	// and never implies the absence of others.
	IssueFieldEvent []*GithubIssueFieldEvent `protobuf:"bytes,52,rep,name=issue_field_event,json=issueFieldEvent,proto3" json:"issue_field_event,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *GithubIssueMutation) GetIssueFieldEvent() []*GithubIssueFieldEvent {
	if x != nil {
		return x.IssueFieldEvent
	}
	return nil
}
...
// GithubIssueFieldEvent records one change to an org-level "Issue field" on an
// issue: the field being set, changed, or cleared. Unlike GithubIssueFieldValue,
// which is a snapshot of current values, these carry GitHub's own timestamp for
// when the change happened.
type GithubIssueFieldEvent struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`                                            // GraphQL node ID
	EventType     string                 `protobuf:"bytes,2,opt,name=event_type,json=eventType,proto3" json:"event_type,omitempty"`             // "added", "changed", "removed"
	FieldName     string                 `protobuf:"bytes,3,opt,name=field_name,json=fieldName,proto3" json:"field_name,omitempty"`             // the issue field's name
	PreviousValue string                 `protobuf:"bytes,4,opt,name=previous_value,json=previousValue,proto3" json:"previous_value,omitempty"` // display value before; empty for "added"
	Value         string                 `protobuf:"bytes,5,opt,name=value,proto3" json:"value,omitempty"`                                      // display value after; empty for "removed"
...
func (x *GithubIssueFieldEvent) Reset() {
	*x = GithubIssueFieldEvent{}
	mi := &file_maintner_proto_msgTypes[32]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GithubIssueFieldEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GithubIssueFieldEvent) ProtoMessage() {}

func (x *GithubIssueFieldEvent) ProtoReflect() protoreflect.Message {
	mi := &file_maintner_proto_msgTypes[32]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GithubIssueFieldEvent.ProtoReflect.Descriptor instead.
func (*GithubIssueFieldEvent) Descriptor() ([]byte, []int) {
	return file_maintner_proto_rawDescGZIP(), []int{32}
}

func (x *GithubIssueFieldEvent) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *GithubIssueFieldEvent) GetEventType() string {
	if x != nil {
		return x.EventType
	}
	return ""
...
func (x *GithubIssueFieldEvent) GetFieldName() string {
	if x != nil {
		return x.FieldName
	}
	return ""
...
func (x *GithubIssueFieldEvent) GetPreviousValue() string {
	if x != nil {
...
func (x *GithubIssueFieldEvent) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
func (x *GithubIssueFieldEvent) GetActorId() int64 {
	if x != nil {
		return x.ActorId
	}
	return 0
...
func (x *GithubIssueFieldEvent) GetCreated() *timestamppb.Timestamp {
	if x != nil {
		return x.Created
	}
	return nil
...
const file_maintner_proto_rawDesc = "" +
	...
	"\x11meta_changed_date\x183 \x01(\v2\x1a.google.protobuf.TimestampR\x0fmetaChangedDate\x12J\n" +
	"\x11issue_field_event\x184 \x03(\v2\x1e.maintpb.GithubIssueFieldEventR\x0fissueFieldEvent\"\x1e\n" +
	"\n" +
	"BoolChange\x12\x10\n" +
	...
	"\x15GithubIssueFieldEvent\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1d\n" +
	"\n" +
	"event_type\x18\x02 \x01(\tR\teventType\x12\x1d\n" +
	"\n" +
	"field_name\x18\x03 \x01(\tR\tfieldName\x12%\n" +
	"\x0eprevious_value\x18\x04 \x01(\tR\rpreviousValue\x12\x14\n" +
	"\x05value\x18\x05 \x01(\tR\x05value\x12\x19\n" +
	"\bactor_id\x18\x06 \x01(\x03R\aactorId\x124\n" +
	"\acreated\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\acreated\"\xa2\x02\n" +
...
var file_maintner_proto_goTypes = []any{
	...
	(*GithubIssueFieldEvent)(nil),       // 32: maintpb.GithubIssueFieldEvent
...
var file_maintner_proto_depIdxs = []int32{
	...
	32, // 39: maintpb.GithubIssueMutation.issue_field_event:type_name -> maintpb.GithubIssueFieldEvent
	...
	38, // 69: maintpb.GithubIssueFieldEvent.created:type_name -> google.protobuf.Timestamp
