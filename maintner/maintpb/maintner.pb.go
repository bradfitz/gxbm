...
const file_maintner_maintpb_maintner_proto_rawDesc = "" +
	"\n" +
	"\x1fmaintner/maintpb/maintner.proto\x12\amaintpb\x1a\x1fgoogle/protobuf/timestamp.proto\"\xd5\x01\n" +
	"\bMutation\x12?\n" +
...
var (
	...
	file_maintner_maintpb_maintner_proto_rawDescData []byte
)

func file_maintner_maintpb_maintner_proto_rawDescGZIP() []byte {
	file_maintner_maintpb_maintner_proto_rawDescOnce.Do(func() {
		file_maintner_maintpb_maintner_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_maintner_maintpb_maintner_proto_rawDesc), len(file_maintner_maintpb_maintner_proto_rawDesc)))
	})
...
var file_maintner_maintpb_maintner_proto_goTypes = []any{
...
func file_maintner_maintpb_maintner_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_maintner_maintpb_maintner_proto_rawDesc), len(file_maintner_maintpb_maintner_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   22,
			NumExtensions: 0,
			NumServices:   0,
